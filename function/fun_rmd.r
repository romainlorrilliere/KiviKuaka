...
exploration_rmd <- function(data,file.rmd = "exploration_dataGPS.Rmd",rep.out="output_html",output_file="exploration_dataGPS",format_output="html",render.clean=TRUE)
rmarkdown::render(,)
