...
source("functions/fun_getData.r")
source("functions/fun_rmd.r")
source("functions/fun_importation.r")



main_exploration_rmd <- function(importing=TRUE,exploration=FALSE,importing_file.rmd="importing_data_update.rmd",importing_file.out="importing_dataGPS",exploration_file.rmd="importing_data_update.rmd",exploration_file.out="importing_dataGPS",rep.out="output_html",format_output="html",file.data="data/data_kivikuaka_envents.csv",user = "romainlorrilliere",pw="xxx",save.fig=FALSE,render.clean=TRUE) {
